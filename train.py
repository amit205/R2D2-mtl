...
default_net = "Fast_Quad_L2Net_Semantics_ConfCFS()"
...
db_kitti360 = """SyntheticPairDataset(
    kitti360, 
            'RandomScale(256,1024,can_upscale=True)', 
            'RandomTilting(0.5), PixelNoise(25)')"""
...
if __name__ == '__main__':
    ...
    parser.add_argument("--batch-size", "--bs", type=int, default=4, help="batch size") # changed batch_size from 8 to 1 # 9th Oct 2023
    ...
    net = eval(args.net)
    print(" Model size: ",common.model_size(net)/1000,"K parameters")
