...
class PairDataset (Dataset):
    ...
    def get_semantics(self, semantics_idx):
        return Dataset.get_semantics(self, semantics_idx)
...
class SyntheticPairDataset (PairDataset):
    ...
    def attach_dataset(self, dataset):
        ...
        self.get_semantics = dataset.get_semantics
        self.root = None
    ...
    def get_pair(self, i, output=('aflow')):
        ...
        semantics = self.dataset.get_semantics(i)
        # scaled_image = self.scale(original_img)
        # scaled_semantics = self.scale(semantics)
        # print("scaled_image: ", scaled_image.size)
        # print("scaled_semantics: ", scaled_semantics.size)

        # scaled_image, scaled_image2 = self.make_pair(scaled_image)

        scaled_image, scaled_image2 = self.make_pair(original_img)
        ...
        return scaled_image, scaled_and_distorted_image['img'], meta, semantics
